...
CUDA_VISIBLE_DEVICES=$gpu python3 analysis.py --correction --backend jax \
 ...
 --analysis_dir /export/jyuan98/FMint_SDE/analysis/results/Jul27_zeroshot/icon_lm_learn_s$seed-$stamp_${data} \
 --restore_dir /export/jyuan98/FMint_SDE/save/user/ckpts/icon_lm/$stamp \
 --restore_step 1000000 \
 --batch_size $bs > results/Jul27_zeroshot/out_analysis_icon_lm_learn_s$seed-$stamp_${data}.log 2>&1 
