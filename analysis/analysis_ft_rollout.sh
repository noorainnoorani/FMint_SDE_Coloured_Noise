...
CUDA_VISIBLE_DEVICES=$gpu python3 analysis.py --correction --backend jax \
 ...
 --loss_mode nocap \
 --test_data_dirs /export/jyuan98/FMint_SDE/data_preparation/rollout/$data\
 --analysis_dir /export/jyuan98/FMint_SDE/analysis/results/rollout/icon_lm_learn_s$seed-$stamp_${data}_new \
 --restore_dir /export/jyuan98/FMint_SDE/save/user/ckpts/icon_lm/$stamp \
 --restore_step 2000 \
 --batch_size $bs > results/rollout/out_analysis_icon_lm_learn_s$seed-$stamp_${data}_new.log 2>&1 
...
#  --model_config_filename 'model_lm_config.json' \
#  --loss_mode nocap \
#  --test_data_dirs /export/jyuan98/FMint_SDE/data_preparation/rollout_five/$data\
#  --analysis_dir /export/jyuan98/FMint_SDE/analysis/results/rollout_five/icon_lm_learn_s$seed-$stamp_${data} \
#  --restore_dir /export/jyuan98/FMint_SDE/save/user/ckpts/icon_lm/$stamp \
#  --restore_step 1000 \
#  --batch_size $bs > results/rollout_five/out_analysis_icon_lm_learn_s$seed-$stamp_${data}.log 2>&1 
...
#  --loss_mode nocap \
#  --test_data_dirs /export/jyuan98/FMint_SDE/data_preparation/rollout_five/$data\
#  --analysis_dir /export/jyuan98/FMint_SDE/analysis/results/rollout_five/icon_lm_learn_s$seed-$stamp_${data}_new \
#  --restore_dir /export/jyuan98/FMint_SDE/save/user/ckpts/icon_lm/$stamp \
#  --restore_step 2000 \
#  --batch_size $bs > results/rollout_five/out_analysis_icon_lm_learn_s$seed-$stamp_${data}_new.log 2>&1 
