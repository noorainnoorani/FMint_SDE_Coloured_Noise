...
CUDA_VISIBLE_DEVICES=$gpu python3 analysis.py --correction --backend jax \
 ...
 --analysis_dir /export/jyuan98/FMint_SDE/analysis/results/Jul27_zeroshot_caption/icon_lm_learn_s$seed-$stamp_${data} \
 --restore_dir /export/jyuan98/FMint_SDE/save/user/ckpts/icon_lm/$stamp \
 --restore_step 1000000 \
 --batch_size $bs > results/Jul27_zeroshot_caption/out_analysis_icon_lm_learn_s$seed-$stamp_${data}.log 2>&1 
...
CUDA_VISIBLE_DEVICES=$gpu python3 analysis.py --correction --backend jax \
 ...
 --model_config_filename 'model_lm_config.json' \
 --test_data_dirs /export/jyuan98/FMint_SDE/data_preparation/SDE_ft_Aug1/$data\
 --analysis_dir /export/jyuan98/FMint_SDE/analysis/results/Jul27_zeroshot_caption/icon_lm_learn_s$seed-$stamp_${data}_new \
 --restore_dir /export/jyuan98/FMint_SDE/save/user/ckpts/icon_lm/$stamp \
 --restore_step 1000000 \
 --batch_size $bs > results/Jul27_zeroshot_caption/out_analysis_icon_lm_learn_s$seed-$stamp_${data}_new.log 2>&1 
