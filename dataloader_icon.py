...
def build_feature(equation, caption, input_id, embedding_raw, embedding_pool, embedding_mask,
	...
	'''
	demo_qoi_k = tf.pad(demo_qoi_k, [[0,0],[0,0],[0, 2 - tf.shape(demo_qoi_k)[-1]]])
	quest_qoi_k = tf.pad(quest_qoi_k, [[0,0],[0,0],[0, 2 - tf.shape(quest_qoi_k)[-1]]])
...
class DataProvider():
	...
	def load_caption(self, mode):
		file_dict = {
			...
			"law_cooling":"cooling",
			"vander_pol":"van_der_pol",
			"dampedharmonic_oscillator": "damped_harmonic",
		}
...
if __name__ == "__main__":
		...
		file_names = '/export/jyuan98/learn2correct/data_preparation/icon_all/train*'
		# file_names = '/export/jyuan98/learn2correct/data_preparation/nv_data/train*'
