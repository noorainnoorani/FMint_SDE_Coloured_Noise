...
lorenz_attractor_batch_fn = jax.jit(jax.vmap(lorenz_fn, [0,0, None, None, None, None, None], (0,0,0)), static_argnums=(-2,-1,))
rossler_attractor_batch_fn = jax.jit(jax.vmap(rossler_fn, [0,0, None, None, None, None, None], (0,0,0)), static_argnums=(-2,-1,))
thomas_attractor_batch_fn = jax.jit(jax.vmap(thomas_fn, [0,0, None, None, None, None, None], (0,0,0)), static_argnums=(-2,-1,))
