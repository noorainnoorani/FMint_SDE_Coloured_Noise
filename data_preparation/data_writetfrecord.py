...
def write_NeurVec_1st_order_tfrecord(name, eqn_type, all_params, all_eqn_captions, all_ts, all_ys, all_errors,alpha):
...
def write_NeurVec_2nd_order_tfrecord(name, eqn_type, all_params, all_eqn_captions, all_ts, all_ys, all_errors,alpha):
	num = all_errors[0].shape[0]
...
def write_NeurVec_3rd_order_tfrecord(name, eqn_type, all_params, all_eqn_captions, all_ts, all_ys, all_errors,alpha):
	num = all_errors[0].shape[0]
